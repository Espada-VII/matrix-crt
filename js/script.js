...
function resize() {
  ...
  // Keep the WebGL drawing buffer matched to the browser viewport.
  // This preserves the original Lively look while allowing GitHub Pages
  // to resize correctly when the browser window/orientation changes.
